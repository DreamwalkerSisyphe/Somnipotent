...
import com.dream.somnipotent.LDEInformationAdapter;
...
public class LucidDreamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LucidDreamActivity.this,LDEAddDataActivity.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(LucidDreamActivity.this,LDEUpdateActivity.class);
    ...
    public void view() {
        ...
        arrayAdapter = new LDEInformationAdapter(this, arrayList);//passing context and arrayList to arrayAdapter
            ...
            public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
                ...
                if(menuItem.getItemId() == R.id.deleteContextMenuId){
                    for(String i : selectList){
                        ...
                        Intent intent = new Intent(LucidDreamActivity.this,LucidDreamActivity.class);
