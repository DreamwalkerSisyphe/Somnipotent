...
public class RCSqliteDatabase extends SQLiteOpenHelper {
    public static final String databaseName = "rcuser.db";
    public static final String tableName = "rcuserTable";
    public static final String col_1 = "id";
    public static final String col_2 = "subject";
    public static final String col_3 = "description";

    //this constructor for creating the database
    public RCSqliteDatabase(Context context) {
