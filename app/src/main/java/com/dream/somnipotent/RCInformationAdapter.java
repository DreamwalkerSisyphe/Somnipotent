...
public class RCInformationAdapter extends ArrayAdapter<RCInformation> {
    Context context;
    ArrayList<RCInformation> ItemList;

    public RCInformationAdapter(@NonNull Context context, ArrayList<RCInformation> ItemList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        RCInformation item = ItemList.get(position);
