...
import com.dream.somnipotent.InformationAdapter;
...
public class DreamJournalActivity extends AppCompatActivity {
    ListView listView;
    SqliteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dreamjournal);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DreamJournalActivity.this,AddDataActivity.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(DreamJournalActivity.this,UpdateActivity.class);
            ...
            public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
                ...
                if(menuItem.getItemId() == R.id.deleteContextMenuId){
                    for(String i : selectList){
                        ...
                        Intent intent = new Intent(DreamJournalActivity.this,DreamJournalActivity.class);
