...
public class LDESqliteDatabase extends SQLiteOpenHelper {
    public static final String databaseName = "ldeuser.db";
    public static final String tableName = "ldeuserTable";
    public static final String col_1 = "id";
    public static final String col_2 = "subject";
    public static final String col_3 = "description";

    //this constructor for creating the database
    public LDESqliteDatabase(Context context) {
    ...
    public long insertData(String subject, String description) {
    ...
    public boolean update(String subject,String description,String id){
        try{
