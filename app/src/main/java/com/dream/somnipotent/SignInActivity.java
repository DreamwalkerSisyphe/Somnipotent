...
public class SignInActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Skip button to not use google log in
        Button skipButt = (Button)findViewById(R.id.skip_button);
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            //updateUI(account);
            // Instead of going to the updateUI we just go to homescreen if sign in successful
            startActivity(new Intent(SignInActivity.this, HomeScreenActivity.class));
